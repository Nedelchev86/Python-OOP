...
class ConcertTrackerApp:
    ...
    def start_concert(self, concert_place: str, band_name: str):
        ...
        if concert.genre == "Rock":
            try:
                d_skills = [d for d in drummer if "play the drums with drumsticks" in d.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")
            try:
                s_skills = [s for s in singer if "sing high pitch notes" in s.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")

            try:
                g_skills = [g for g in guitarist if "play rock" in g.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")
            ...
            try:
                ...
                raise Exception(f"The {band_name} band is not ready to play at the concert!")
            try:
                s_skills = [s for s in singer if "sing low pitch notes" in s.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")

            try:
                g_skills = [g for g in guitarist if "play metal" in g.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")

        elif concert.genre == "Jazz":
            try:
                d_skills = [d for d in drummer if "play the drums with drum brushes" in d.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")
            try:
                s_skills = [s for s in singer if "sing high pitch notes" in s.skills and "sing low pitch notes" in s.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")

            try:
                g_skills = [g for g in guitarist if "play jazz" in g.skills][0]
            except IndexError:
                raise Exception(f"The {band_name} band is not ready to play at the concert!")
